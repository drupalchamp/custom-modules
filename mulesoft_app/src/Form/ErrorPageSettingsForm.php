...
class ErrorPageSettingsForm extends ConfigFormBase {
  ...
  public function getFormId() {
    return 'mulesoft_app_error_page_settings_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $config = $this->config('mulesoft_app.error_page');
    ...
    $form['error_page']['error_page_content'] = [
      ...
      '#format' => $config->get('error_page_content.format') ?? 'restricted_html',
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    $this->config('mulesoft_app.error_page')
      ->set('error_page_title', $form_state->getValue('error_page_title'))
      ->set('error_page_content.format', $form_state->getValue([
        'error_page_content',
        'format',
      ]))
      ->set('error_page_content.value', $form_state->getValue([
        'error_page_content',
        'value',
      ]))
